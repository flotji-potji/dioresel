...
rule vcftools_step_window:
    ...
    output:
        "raw_data/vcftools/fst_step_window/vieref_{sp1}_{sp2}.{size}.step.windowed.weir.fst"
    params:
        output_format="raw_data/vcftools/fst_step_window/vieref_{sp1}_{sp2}.{size}.step",
        window_size="{size}",
    envmodules:
        "vcftools"
    shell:
...
rule r_plot_fst:
    ...
    output:
        "results/fst_plots/pair_{sp1}_{sp2}.{size}.fst.jpg"
    params:
