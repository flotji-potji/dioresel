#!/bin/bash
#
#SBATCH --job-name=orfTrans
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem=5G
#SBATCH --time=0-01:00:00
#SBATCH --partition=basic,short
#SBATCH --output=/lisc/scratch/botany/frschmidt/mk_test/logs/orf_transdecoder%j.log
#SBATCH --error=/lisc/scratch/botany/frschmidt/mk_test/logs/orf_transdecoder%j.err
